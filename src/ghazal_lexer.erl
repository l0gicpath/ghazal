-file("/opt/local/lib/erlang/lib/parsetools-2.0.2/include/leexinc.hrl", 0).
...
-file("./ghazal_lexer.xrl", 25).

-file("/opt/local/lib/erlang/lib/parsetools-2.0.2/include/leexinc.hrl", 14).
...
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 47 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Tlen+1, 3, Tlen);
yystate(18, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 47 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(16, Ics, Line, Tlen+1, 3, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 58, C =< 68 ->
    yystate(17, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 39 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
    yystate(17, Ics, Line, Tlen+1, Action, Alen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(17, Ics, Line, Tlen+1, 8, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 47 ->
    yystate(17, Ics, Line, Tlen+1, 8, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Tlen+1, 8, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(17, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(3, Ics, Line, Tlen+1, 8, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 42 ->
    yystate(3, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(18, Ics, Line, Tlen+1, 8, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(17, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(17, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 45 ->
    yystate(17, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(8, Ics, Line, Tlen+1, 4, Tlen);
yystate(8, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(17, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(4, Ics, Line, Tlen, _, _) ->
    {2,Tlen,Ics,Line,4};
yystate(3, [40|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(3, [41|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
-file("./ghazal_lexer.xrl", 5).
yyaction_0(TokenChars, TokenLine) ->
     { token, { string, TokenLine, string : strip (TokenChars, both, 34) } } .

-compile({inline,yyaction_1/0}).
-file("./ghazal_lexer.xrl", 7).
yyaction_1() ->
     skip_token .

-compile({inline,yyaction_2/2}).
-file("./ghazal_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
     { token, { atom, TokenLine, list_to_atom (string : strip (TokenChars, left, 58)) } } .

-compile({inline,yyaction_3/2}).
-file("./ghazal_lexer.xrl", 11).
yyaction_3(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./ghazal_lexer.xrl", 13).
yyaction_4(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_5/1}).
-file("./ghazal_lexer.xrl", 15).
yyaction_5(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("./ghazal_lexer.xrl", 17).
yyaction_6(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_7/0}).
-file("./ghazal_lexer.xrl", 19).
yyaction_7() ->
     skip_token .

-compile({inline,yyaction_8/2}).
-file("./ghazal_lexer.xrl", 21).
yyaction_8(TokenChars, TokenLine) ->
     { token, { identifier, TokenLine, TokenChars } } .

-file("/opt/local/lib/erlang/lib/parsetools-2.0.2/include/leexinc.hrl", 282).
